...
export function AddStudentModal({ isOpen, onClose, onAdd, newStudent, setNewStudent }: AddStudentModalProps) {
  return (
    <AnimatePresence>
      {isOpen && (
          ...
          >
            ...
            <form onSubmit={onAdd} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    onChange={e => setNewStudent({...newStudent, plan_start_date: e.target.value})}
                  />
                </div>
              </div>
              <div>
              ...
              <div className="pt-4">
                <button 
                  type="submit"
                  className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-emerald-600/20 flex items-center justify-center gap-2 cursor-pointer"
                >
                  <Plus size={20} />
                  Cadastrar Aluno
                </button>
